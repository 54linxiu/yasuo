$(function(){
    ...
    lil.addClass("smallb");
    ulll.find('li').each(function(){//亚索图片切换
        $(this).click(function(){
            // alert($(this).index())
            $("#snal ul li:eq("+$(this).index()+")").addClass("smallb").siblings().removeClass("smallb");
    ...
    jnli.each(function(i){
        $(this).click(function(){
            ...
            $(".jnjs div.jnms").eq(i).removeClass("jnxs").siblings(".jnjs div.jnms").addClass("jnxs");
        })
    })
})